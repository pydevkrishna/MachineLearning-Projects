...
predictions = dt_model.predict(new_transactions)
probabilities = dt_model.predict_proba(new_transactions)
    ...
    while True:
        try:
            ...
            if 0 <= time <= 24 and 1 <= location <= 4:
                ...
                prediction = dt_model.predict(transaction)[0]
                probability = dt_model.predict_proba(transaction)[0][1]
